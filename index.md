          ...
          <div class="col-12">
            ...
            <div class="ml-auto mr-0 tm-bg-black-transparent text-white tm-brand-container-inner">
              <div class="tm-brand-container text-center">
                <h1 class="tm-brand-name">Dhener's Profile</h1>
                <p class="tm-brand-description mb-0">Just starting up</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row h-100">
            ...
            <div class="col-md-7 tm-welcome-left-col">
              <div class="tm-welcome-left">
                <h2 class="tm-welcome-title">Welcome to Dhener's Profile Page</h2>
                <p class="pb-0">
                  I am just testing this to add it in my GitHub as test subject. Information here and not true.
                </p>
              </div>
            </div>
            <!-- Brown bg -->
